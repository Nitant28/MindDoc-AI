    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md p-8 border border-gray-200">
        <div className="text-center mb-8">
          <div className="flex justify-center mb-8 animate-float">
            <svg width="96" height="96" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
              <defs>
                <linearGradient id="md-gradient-login" x1="0" y1="0" x2="1" y2="1">
                  <stop offset="0%" stopColor="#2b6ef6"/>
                  <stop offset="60%" stopColor="#6d28d9"/>
                </linearGradient>
                <radialGradient id="md-glow-login" cx="50%" cy="30%" r="50%">
                  <stop offset="0%" stopColor="#ffffff" stopOpacity="0.35"/>
                  <stop offset="100%" stopColor="#ffffff" stopOpacity="0"/>
                </radialGradient>
                <filter id="md-drop-login" x="-20%" y="-20%" width="140%" height="140%">
                  <feDropShadow dx="0" dy="3" stdDeviation="4" floodColor="#0b3b91" floodOpacity="0.08"/>
                </filter>
              </defs>
              <g filter="url(#md-drop-login)">
              ...
              <g transform="translate(20,6)">
                <g transform="scale(0.9)">
                  <path d="M20 14 C12 14 8 20 8 24 C4 24 2 28 2 32 C2 36 6 40 12 40 H44 C52 40 58 34 58 28 C58 24 54 18 48 18 C46 12 40 8 34 10 C30 6 24 6 20 14 Z" fill="url(#md-gradient-login)" />
                  <path d="M12 22 C10 18 14 14 18 14 C22 10 30 10 34 14 C40 12 46 16 48 20" fill="url(#md-glow-login)" opacity="0.6" />
          ...
          <p className="text-lg text-gray-600">Sign in to MindDoc AI</p>
        </div>
        ...
        <p className="mt-6 text-center text-gray-600 text-sm">
          Don't have an account? <a href="/register" className="text-blue-600 hover:text-blue-700 font-semibold underline">Register here</a>
        </p>
      </div>
    </div>
  );
